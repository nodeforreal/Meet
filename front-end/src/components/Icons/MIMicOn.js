...
const MIMic = ({ strokeColor, size }) => {
  return (
    <svg width={size || "16"} height={size || "16"} viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M12 19.5V22.5" stroke={strokeColor ? strokeColor : "#0060FF"} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
